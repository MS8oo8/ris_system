...
#address_req = "tcp://192.168.8.180:5559"
address_push_f = "tcp://192.168.8.180:5562"  # PUSH do serwera
address_pull_f = "tcp://192.168.8.180:5563"
address_push = "tcp://192.168.8.180:5566"  # PUSH do serwera
address_pull = "tcp://192.168.8.180:5567"  # PULL od serwera
rx_name = "RX_2"  # Identyfikator RX

if ON_WINDOWS:
    #address_req = "tcp://localhost:5559"
    address_push_f = "tcp://localhost:5562"  # PUSH do serwera
    address_pull_f = "tcp://localhost:5563"
    address_push = "tcp://localhost:5566"
    address_pull = "tcp://localhost:5567"

context = zmq.Context()

# socket_req = context.socket(zmq.REQ)  # :5559
# socket_req.connect(address_req)
